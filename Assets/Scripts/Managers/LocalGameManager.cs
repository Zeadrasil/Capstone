...
public class LocalGameManager : MonoBehaviour
{
    ...
    [SerializeField] GameObject fastRangedEnemy;
    [SerializeField] GameObject swarmRangedEnemy;
    [SerializeField] GameObject fastSwarmRangedEnemy;
    [SerializeField] GameObject tankRangedEnemy;
    [SerializeField] GameObject fastTankRangedEnemy;
    [SerializeField] GameObject swarmTankRangedEnemy;
    [SerializeField] GameObject fastSwarmTankRangedEnemy;
    [SerializeField] GameObject deadlyRangedEnemy;
    [SerializeField] GameObject fastDeadlyRangedEnemy;
    [SerializeField] GameObject swarmDeadlyRangedEnemy;
    [SerializeField] GameObject fastSwarmDeadlyRangedEnemy;
    [SerializeField] GameObject tankDeadlyRangedEnemy;
    [SerializeField] GameObject fastTankDeadlyRangedEnemy;
    [SerializeField] GameObject swarmTankDeadlyRangedEnemy;
    [SerializeField] GameObject fastSwarmTankDeadlyRangedEnemy;
    [SerializeField] GameObject spammyRangedEnemy;
    [SerializeField] GameObject fastSpammyRangedEnemy;
    [SerializeField] GameObject swarmSpammyRangedEnemy;
    [SerializeField] GameObject fastSwarmSpammyRangedEnemy;
    [SerializeField] GameObject tankSpammyRangedEnemy;
    [SerializeField] GameObject fastTankSpammyRangedEnemy;
    [SerializeField] GameObject swarmTankSpammyRangedEnemy;
    [SerializeField] GameObject fastSwarmTankSpammyRangedEnemy;
    [SerializeField] GameObject deadlySpammyRangedEnemy;
    [SerializeField] GameObject fastDeadlySpammyRangedEnemy;
    [SerializeField] GameObject swarmDeadlySpammyRangedEnemy;
    [SerializeField] GameObject fastSwarmDeadlySpammyRangedEnemy;
    [SerializeField] GameObject tankDeadlySpammyRangedEnemy;
    ...
    void Start()
    {
        ...
        GameManager.Instance.rangedEnemy = rangedEnemy;
        GameManager.Instance.fastRangedEnemy = fastRangedEnemy;
        GameManager.Instance.swarmRangedEnemy = swarmRangedEnemy;
        GameManager.Instance.fastSwarmRangedEnemy = fastSwarmRangedEnemy;
        GameManager.Instance.tankRangedEnemy = tankRangedEnemy;
        GameManager.Instance.fastTankRangedEnemy = fastTankRangedEnemy;
        GameManager.Instance.swarmTankRangedEnemy = swarmTankRangedEnemy;
        GameManager.Instance.fastSwarmTankRangedEnemy = fastSwarmTankRangedEnemy;
        GameManager.Instance.deadlyRangedEnemy = deadlyRangedEnemy;
        GameManager.Instance.fastDeadlyRangedEnemy = fastDeadlyRangedEnemy;
        GameManager.Instance.swarmDeadlyRangedEnemy = swarmDeadlyRangedEnemy;
        GameManager.Instance.fastSwarmDeadlyRangedEnemy = fastSwarmDeadlyRangedEnemy;
        GameManager.Instance.tankDeadlyRangedEnemy = tankDeadlyRangedEnemy;
        GameManager.Instance.fastTankDeadlyRangedEnemy = fastTankDeadlyRangedEnemy;
        GameManager.Instance.swarmTankDeadlyRangedEnemy = swarmTankDeadlyRangedEnemy;
        GameManager.Instance.fastSwarmTankDeadlyRangedEnemy = fastSwarmTankDeadlyRangedEnemy;
        GameManager.Instance.spammyRangedEnemy = spammyRangedEnemy;
        GameManager.Instance.fastSpammyRangedEnemy = fastSpammyRangedEnemy;
        GameManager.Instance.swarmSpammyRangedEnemy = swarmSpammyRangedEnemy;
        GameManager.Instance.fastSwarmSpammyRangedEnemy = fastSwarmSpammyRangedEnemy;
        GameManager.Instance.tankSpammyRangedEnemy = tankSpammyRangedEnemy;
        GameManager.Instance.fastTankSpammyRangedEnemy = fastTankSpammyRangedEnemy;
        GameManager.Instance.swarmTankSpammyRangedEnemy = swarmTankSpammyRangedEnemy;
        GameManager.Instance.fastSwarmTankSpammyRangedEnemy = fastSwarmTankSpammyRangedEnemy;
        GameManager.Instance.deadlySpammyRangedEnemy = deadlySpammyRangedEnemy;
        GameManager.Instance.fastDeadlySpammyRangedEnemy = fastDeadlySpammyRangedEnemy;
        GameManager.Instance.swarmDeadlySpammyRangedEnemy = swarmDeadlySpammyRangedEnemy;
        GameManager.Instance.fastSwarmDeadlySpammyRangedEnemy = fastSwarmDeadlySpammyRangedEnemy;
        GameManager.Instance.tankDeadlySpammyRangedEnemy = tankDeadlySpammyRangedEnemy;
